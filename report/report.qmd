...
The model which considers both risk and attention features has an accuracy rate of 52.43% for the training data and 24.12% for the competition data. This suggests that the model is overfitting, as the accuracy rate is much lower for the competition data. The loss value (MSE) for the training data is 0.25, while for the competition data it is 0.35.
